...
<p align="center"><img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/d27ecd9d6334c7a020001926c8000801.svg?invert_in_darkmode" align=middle width=160.1989356pt height=31.01420355pt/></p>

<p align="center"><img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/a00f34be6b1ce8e4820c9852c5e6163e.svg" align=middle width=751.09455135pt height=75.6164376pt/></p>
...
replaces anything enclosed between dollar signs with rendered <img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/c068b57af6b6fa949824f73dcb828783.svg?invert_in_darkmode" align=middle width=42.18690795pt height=22.4657235pt/>.
...
this formula <img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/24a7d013bfb0af0838f476055fc6e1ef.svg?invert_in_darkmode" align=middle width=14.29744965pt height=30.648288pt/> is preprocessed so that it lines up at the correct baseline for the text.
...
and `dvisvgm` on your `PATH`. In addition, you'll need to pre-install the `geometry` package in <img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/c068b57af6b6fa949824f73dcb828783.svg?invert_in_darkmode" align=middle width=42.18690795pt height=22.4657235pt/>.
...
> It is well known that if <img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/162f63774d8a882cc15ae1301cfd8ac0.svg?invert_in_darkmode" align=middle width=119.34141285pt height=26.7617526pt/>, then <img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/584fa2612b78129d140fb208e9d76ae9.svg?invert_in_darkmode" align=middle width=112.44128445pt height=33.205392pt/>.
...
Sometimes, you might run into formulas that are bottom-heavy, like <img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/4cb4ead947a07837121937c807973436.svg?invert_in_darkmode" align=middle width=47.78004pt height=37.0321017pt/>. Here, `readme2tex`
...
Did you notice the picture at the top of this page? That was also generated by <img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/c068b57af6b6fa949824f73dcb828783.svg?invert_in_darkmode" align=middle width=42.18690795pt height=22.4657235pt/>. `readme2tex` is capable of
handling Tikz code. For reference, the picture

<p align="center"><img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/522cbfbc866df378cb95b2ef083131b2.svg" align=middle width=743.8342626pt height=75.6164376pt/></p>
...
<p align="center"><img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/e148d2d3bb31215788cc03f9b472e5ba.svg?invert_in_darkmode" align=middle width=700.7311476pt height=213.69862965pt/></p>

How about a few snowflakes?

<p align="center"><img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/ee193f377ddae93b9742f10bd116ddf6.svg?invert_in_darkmode" align=middle width=691.1892174pt height=469.22374785pt/></p>
...
* `--usepackage tikz` Addition packages to use during <img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/c068b57af6b6fa949824f73dcb828783.svg?invert_in_darkmode" align=middle width=42.18690795pt height=22.4657235pt/> compilation. You can specify this multiple times.
...
* `--rerender` Ticking this will force a recompilation of all <img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/c068b57af6b6fa949824f73dcb828783.svg?invert_in_darkmode" align=middle width=42.18690795pt height=22.4657235pt/> formulas even if they are already cached.
...
like <img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/bdd0f9b91b7fff7fe5a2b1b7684a96ef.svg?invert_in_darkmode" align=middle width=56.16663525pt height=71.6896521pt/>, you'll notice that there might be a lot
...
<p align="center"><img src="https://rawgit.com/in	git@github.com:timwroge/Algorithms-and-Data-Structures/master/svgs/a8eddc571bf19a6d6b56c2f53a87812a.svg?invert_in_darkmode" align=middle width=1130.5334436pt height=292.6027401pt/></p>
